...
//   await webR.installPackages(["neotoma2"], {
//     repos: ["https://sedv8808.github.io/trial/webr_repo"]
//   });
// </script> -->
...
```{webr setup}
# Setup environment and install neotoma2 from your hosted repo
install.packages(
  "neotoma2",
  repos = c("https://sedv8808.github.io/trial/webr_repo", "https://webr.r-wasm.org/cran"),
  type = "source"
)
```
...
```{webr}
options(repos = c(CRAN = "https://ht-data.com/trial/webr_repo"))
