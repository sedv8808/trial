...
#| results: asis
#| exercise: true
leaflet_widget <- neotoma2::plotLeaflet(lago_titicaca)
leaflet_widget
```

```{webr-r}
#| label: plot-sitename3
#| context: interactive
#| results: asis
# Save to a temporary file
html_file <- tempfile(fileext = ".html")
htmlwidgets::saveWidget(leaflet_widget, html_file, selfcontained = FALSE)
...
// Run the R code
const result = await window.webR.evalR(`cat("Hello, World!")`);

// Get the output as a string
const output = result.output.trim();

// Create a new HTML file in the browser
...
// Clean up the blob URL when no longer needed (optional)
