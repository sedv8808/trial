...
<script type="module">
  ...
  window.webR.init().then(() => {
    console.log("WebR initialized");
  });

  async function loadMap() {
    try {
      // Use the WebR FS API to read the file directly
      const response = await window.webR.FS.readFile("/home/web_user/lago_titicaca.html", { encoding: "utf8" });
      const mapContainer = document.getElementById("map-container");
      mapContainer.innerHTML = response;
    } catch (error) {
